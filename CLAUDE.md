...
```bash
node bin/cli.js new <name> [--platform hono|dotnet|elixir|python] [--template blank|crud] [--design <pack>]  # scaffold a starter project (main.ddd + README + .loomignore), validated before writing
