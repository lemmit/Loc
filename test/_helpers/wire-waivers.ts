...
//
// The registry is now EMPTY, which is the target state — all five backends
// agree with the golden on every recorded path.  Keep it that way: a new
// divergence is a BUG to fix on the diverging backend first, and a waiver only
// when fixing it is a mission of its own with a named exit.
// ---------------------------------------------------------------------------
