...
<KeyValueRow label="Balance"><span data-testid="customers-detail-balance"><NumberValue value={data.balance} decimals={2} /></span></KeyValueRow>

<KeyValueRow label="Vip"><span data-testid="customers-detail-vip"><BoolValue value={data.vip} /></span></KeyValueRow>
