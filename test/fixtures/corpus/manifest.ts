...
export const CORPUS: readonly CorpusFeature[] = [
  ...
  },
  {
    ...
    doc: "auth",
    backends: ALL,
    note: "the two halves render in DIFFERENT places — a create guard has no `this` yet, a destroy guard reads the row the route already loaded; only a fixture carrying both pins each receiver",
  },
  {
    id: "criterion-filter",
