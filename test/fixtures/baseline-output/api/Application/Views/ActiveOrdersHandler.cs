...
public sealed class ActiveOrdersHandler : IQueryHandler<ActiveOrdersQuery, System.Collections.Generic.IReadOnlyList<OrderResponse>>
{
    private readonly IOrderRepository _repo;
    public ActiveOrdersHandler(IOrderRepository repo) => _repo = repo;

    public async ValueTask<System.Collections.Generic.IReadOnlyList<OrderResponse>> Handle(ActiveOrdersQuery q, CancellationToken ct)
    {
