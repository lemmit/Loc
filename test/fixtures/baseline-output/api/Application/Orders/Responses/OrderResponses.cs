...
public sealed record OrderResponse([property: Required] Guid Id, [property: Required] string CustomerId, [property: Required] OrderStatus Status, [property: Required] string PlacedAt, [property: Required] IReadOnlyList<OrderLineResponse> Lines);
