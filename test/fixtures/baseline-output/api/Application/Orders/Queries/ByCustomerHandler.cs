...
public sealed class ByCustomerHandler : IQueryHandler<ByCustomerQuery, IReadOnlyList<OrderResponse>>
{
    ...
    public async ValueTask<IReadOnlyList<OrderResponse>> Handle(ByCustomerQuery q, CancellationToken ct)
    {
