...
public sealed record ProductResponse([property: Required] Guid Id, [property: Required] string Sku, [property: Required] MoneyResponse Price, [property: Required] string Display);
