...
public sealed record OrderResponse(Guid Id, string CustomerId, string Status, string PlacedAt, System.Collections.Generic.IReadOnlyList<OrderLineResponse> Lines);
