...
const FIXTURES: Array<[string, string]> = [
  ...
  // union-find variant-match rendered on the optional twin): auth (user
  // block + requires), extern operations, workflows incl. variant-match,
  // views, finds, value objects, money option/derived, capability stamps,
  // softDelete, seeding, event sourcing.
