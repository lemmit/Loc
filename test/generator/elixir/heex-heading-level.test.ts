...
// NOTE (M-T1.11): the heading TEXT now rides the translation runtime
// (`<%= pgettext(<key>, "Top") %>`), so each assertion matches the text loosely
// inside the tag.  What these tests pin is the derived RANK, which is unchanged.
