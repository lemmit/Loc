...
//      a file becomes selected (files-only check; we don't need
//      esm.sh-fetched Bundle to verify the Run wiring is intact).
...
//
// Part 3 needs esm.sh + jsdelivr (bundle + PGlite WASM); when those
