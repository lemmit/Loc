...
> *"Read `docs/plans/auth-agent-prompt.md`. Your job is `<target>`"* where
...
- Decision + language surface: `docs/auth.md`; running status/plan doc
  `docs/plans/auth-providers-implementation.md` (**update it when you finish**).
...
- **Update** `docs/plans/auth-providers-implementation.md` with what you shipped.
