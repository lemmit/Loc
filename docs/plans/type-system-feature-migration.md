...
> `docs/proposals/implementation-plan.md`; this plan references those
...
> conformance plan (`docs/plans/conformance-parity-restoration.md`,
...
- `docs/proposals/type-system-overview.md` — the family orientation.
- `docs/proposals/payload-transport-layer.md` — transport layer (the
  "macros become obsolete" line here is **rejected** per §0.2).
- `docs/proposals/exception-less.md` — A1–A7 (the throw→typed work
  that §5.1 guards provenance through).
- `docs/proposals/implementation-plan.md` — the canonical phase/delivery
  plan this note layers onto.
- `docs/provenance.md` — the implemented `provenanced` feature.
- `docs/plans/conformance-parity-restoration.md` — the sibling parity
