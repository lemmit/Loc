...
- `docs/generators.md`: Python backend section (file map + per-aggregate
  ...
  `docs/plans/platform-expansion-roadmap.md` Phase E → shipped.
...
- [`docs/plans/platform-expansion-roadmap.md`](platform-expansion-roadmap.md) — Phase E sketch this plan executes.
- [`docs/proposals/java-backend.md`](../proposals/java-backend.md) — the sibling backend plan whose shape this follows.
