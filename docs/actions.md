...
constants and enum members. These seed on **React** (all packs), **Vue**,
**Svelte**, **Angular**, and **Feliz**, in both create forms (field defaults) and
operation forms (param defaults). A mistyped default is rejected at the source,
