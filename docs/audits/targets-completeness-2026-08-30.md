...
| P4 | 91 |
| P5 | 12 |
| kind: silent / honest / breadth / mission / stale-prose | 24 / 32 / 26 / 65 / 12 |
| confidence: proven / likely / suspected | 30 / 127 / 2 |
| class: faulty-fix / regression | 1 / 0 |
| size S / M / L | 43 / 69 / 47 |
| provenance: fleet1-only / fleet2-only / corroborated by both | 142 / 16 / 1 |
