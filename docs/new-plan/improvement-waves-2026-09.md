...
|---|---|---|---|
| ledger P0 open | 1 (the ADP-3 gate; corrected from 4) | 0 | 0 |
| ledger P1 silent open | 11 (corrected from ~21) | 0 (or handed off with owner) | 0 |
