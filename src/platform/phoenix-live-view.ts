...
const phoenixLiveViewPlatform: PlatformSurface = {
  ...
  emitProject({ deployable }): Map<string, string> {
    const out = new Map<string, string>();
    const appName = snakeApp(deployable.name);
    out.set("mix.exs", mixExs(appName));
    out.set(".formatter.exs", FORMATTER_EXS);
    out.set("README.md", `# ${appName}\n\nGenerated by Loom.\n`);
    out.set("Dockerfile", DOCKERFILE);
    out.set(".dockerignore", DOCKERIGNORE);
    return out;
  },
