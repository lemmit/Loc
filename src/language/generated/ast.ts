...
export type Expression = BinaryExpr | BuilderCall | CallExpr | IdRef | Lambda | LiteralExpr | MatchExpr | MemberAccess | MoneyLit | NameRef | NowExpr | ObjectLit | ParenExpr | TernaryExpr | ThisRef | UnaryExpr;
...
export type NameRefIdent = 'aggregates' | 'api' | 'bi' | 'bind' | 'body' | 'cache' | 'component' | 'contains' | 'contexts' | 'design' | 'events' | 'filter' | 'framework' | 'id' | 'implements' | 'link' | 'menu' | 'modules' | 'money' | 'page' | 'permissions' | 'primary' | 'route' | 'search' | 'section' | 'stamp' | 'state' | 'static' | 'targets' | 'title' | 'ui' | 'views' | 'workflows' | string;

export function isNameRefIdent(item: unknown): item is NameRefIdent {
    return item === 'permissions' || item === 'ui' || item === 'api' || item === 'money' || item === 'id' || item === 'contains' || item === 'page' || item === 'component' || item === 'state' || item === 'menu' || item === 'section' || item === 'link' || item === 'route' || item === 'title' || item === 'body' || item === 'framework' || item === 'static' || item === 'modules' || item === 'contexts' || item === 'aggregates' || item === 'workflows' || item === 'views' || item === 'design' || item === 'targets' || item === 'bind' || item === 'primary' || item === 'cache' || item === 'search' || item === 'events' || item === 'bi' || item === 'filter' || item === 'stamp' || item === 'implements' || (typeof item === 'string' && (/[_a-zA-Z][\w_]*/.test(item)));
}
