...
export type NameRefIdent = 'api' | 'permissions' | 'ui' | string;

export function isNameRefIdent(item: unknown): item is NameRefIdent {
    return item === 'permissions' || item === 'ui' || item === 'api' || (typeof item === 'string' && (/[_a-zA-Z][\w_]*/.test(item)));
}
