...
export type NameRefIdent = 'aggregates' | 'api' | 'bi' | 'bind' | 'body' | 'cache' | 'component' | 'contains' | 'contexts' | 'design' | 'events' | 'filter' | 'framework' | 'implements' | 'link' | 'menu' | 'modules' | 'money' | 'page' | 'permissions' | 'primary' | 'route' | 'search' | 'section' | 'stamp' | 'state' | 'static' | 'targets' | 'title' | 'ui' | 'views' | 'workflows' | string;
