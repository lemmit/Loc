...
// the few short inputs it sees; not a general-purpose hashing service.
...
/** SHA-256 digest of `data` as a 32-byte Uint8Array. */
export function sha256(data: Uint8Array): Uint8Array {
  const H = new Uint32Array([
    0x6a09e667, 0xbb67ae85, 0x3c6ef372, 0xa54ff53a, 0x510e527f, 0x9b05688c, 0x1f83d9ab, 0x5be0cd19,
  ]);
  // Pad: message ++ 0x80 ++ zeros ++ 64-bit bit-length, to a 64-byte multiple.
