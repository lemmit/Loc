...
// success.  Still DEFERRED to full parity (omitted → they fall back to the
// shared diagnostic-comment path): `renderWorkflowForm` / `renderModal` /
// `renderAction` / `renderUserComponent` and the interactive-table / store seams.
