...
function renderMain(
  ...
  return lines(
    ...
    `"""`,
    "",
    authRequired && !oidc ? "import base64" : null,
    authRequired && !oidc ? "import json" : null,
    "import os",
    "from collections.abc import AsyncIterator",
    "from contextlib import asynccontextmanager",
    authRequired && !oidc ? "from dataclasses import replace" : null,
    ...
    authRequired && !oidc ? "from typing import Any" : null,
    "",
    ...
    ...(oidc
      ...
      : authRequired
        ? [
            ...
            "        if isinstance(getattr(user, k, None), str) and isinstance(v, str)",
            "    }",
