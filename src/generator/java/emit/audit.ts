...
// owns the shared JPA entity + its repository.  The DDL now comes from the
// shared MigrationsIR (`auditTableShape`) like every other companion table —
// this module emits only the ORM-level mapping, which is genuinely
// per-backend.
// ---------------------------------------------------------------------------
